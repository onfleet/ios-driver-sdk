...
@property (nonatomic, readonly, copy) NSURL * _Nullable organizationImageUrl SWIFT_DEPRECATED_MSG("use one of the properties defining image size");
/// Returns an url of org’s image with size 294px; nil if org has no image.
@property (nonatomic, readonly, copy) NSURL * _Nullable organizationImageUrlExtraSmall;
/// Returns an url of org’s image with size 580px; nil if org has no image.
@property (nonatomic, readonly, copy) NSURL * _Nullable organizationImageUrlSmall;
/// Returns an url of org’s image with size 800px; nil if org has no image.
@property (nonatomic, readonly, copy) NSURL * _Nullable organizationImageUrlMedium;
