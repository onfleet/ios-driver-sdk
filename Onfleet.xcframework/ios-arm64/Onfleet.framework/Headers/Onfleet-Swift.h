...
#ifndef ONFLEET_SWIFT_H
#define ONFLEET_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Onfleet",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif


SWIFT_CLASS("_TtC7Onfleet7Account")
...
SWIFT_PROTOCOL("_TtP7Onfleet15SessionManaging_")
...
SWIFT_CLASS("_TtC7Onfleet18AccountsController")
...
@interface AccountsController (SWIFT_EXTENSION(Onfleet))
- (void)changeActiveAccountTo:(Account * _Nonnull)account completion:(void (^ _Nonnull)(void))completion;
@end
...
SWIFT_PROTOCOL("_TtP7Onfleet16AccountsProvider_")
...
SWIFT_PROTOCOL("_TtP7Onfleet18AccountsSubscriber_")
@protocol AccountsSubscriber
...
SWIFT_PROTOCOL("_TtP7Onfleet18ActiveTaskProvider_")
...
SWIFT_PROTOCOL("_TtP7Onfleet20ActiveTaskSubscriber_")
@protocol ActiveTaskSubscriber
...
SWIFT_CLASS("_TtC7Onfleet21AsynchronousOperation")
...
SWIFT_CLASS("_TtC7Onfleet28AsynchronousClosureOperation")
...
SWIFT_CLASS("_TtC7Onfleet6Config")
...
SWIFT_CLASS("_TtC7Onfleet5Model")
...
SWIFT_CLASS("_TtC7Onfleet11Destination")
@interface Destination : Model
@end


SWIFT_CLASS("_TtC7Onfleet9DiskUtils")
...
SWIFT_CLASS("_TtC7Onfleet13DriverContext")
...
@interface DriverContext (SWIFT_EXTENSION(Onfleet))
...
SWIFT_CLASS("_TtC7Onfleet7EnvInfo")
...
SWIFT_CLASS("_TtC7Onfleet13FrameworkInfo")
...
SWIFT_CLASS("_TtC7Onfleet9InfoPlist")
...
static NSString * _Nonnull const LogoutReasonDomain = @"Onfleet.LogoutReason";



SWIFT_CLASS("_TtC7Onfleet12ModelManager")
...
@interface NSURLRequest (SWIFT_EXTENSION(Onfleet))
...
SWIFT_CLASS("_TtC7Onfleet17NotificationToken")
...
SWIFT_CLASS("_TtC7Onfleet12Organization")
...
SWIFT_CLASS("_TtC7Onfleet11PhoneNumber")
...
SWIFT_CLASS("_TtC7Onfleet9Recipient")
@interface Recipient : Model
@end



SWIFT_CLASS("_TtC7Onfleet4Task")
...
SWIFT_CLASS("_TtC7Onfleet7Vehicle")
